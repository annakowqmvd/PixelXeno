...
#[derive(Debug)]
pub struct PixelXenoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PixelXenoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PixelXeno processing");
    
    let mut processor = PixelXenoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PixelXenoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PixelXenoProcessor::new(false);
